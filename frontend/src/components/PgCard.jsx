...
const PgCard = ({ liked = false, property, myProperties = 0 }) => {
      ...
      >
        <div className=" w-[30%] h-auto rounded-xl overflow-hidden ">
          ...
          {property?.images?.length == 0 && (
            <img src={noImage} className="object-cover w-64 h-64" />
          )}
        ...
        {myProperties == 1 && (
          ...
          >
            <button className="capitalize">
              {property?.propertyStatus == 'Sold'  ? "Marked as sold" : "Mark as sold"}
            </button>
          </div>
        )}
