...
const SellCard = ({ liked = false, key, property, myProperties = 0 }) => {
    ...
    <>
      ...
      >
        ...
        <div
          ...
          className="w-[65%] cursor-pointer flex flex-col gap-4  "
        >
          {/* info */}

          <div className="cpaitalize  text-xl flex items-center  gap-2 font-light">
            {property?.bedrooms && <p>{property?.bedrooms} BHK</p>}
            {property.commercialPropertyType && <p>{property.commercialPropertyType}</p>}
          ...
          <div className="flex gap-4  items-center ">
            <div className="flex flex-col gap-1 items-center   font-medium ">
              ...
              <p className=" capitalize flex items-center gap-1 self-center  text-sm ">
                @{" "}
                <span>
                  <FaRupeeSign />
                </span>{" "}
            ...
            {property?.plotArea && (
              <div>
                <p className="text-2xl">{property.plotArea} <span>(sq ft.)</span> </p>
